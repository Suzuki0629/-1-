    ...
    class Program
    {
        ...
        static void Check()
        {
            ...
            { // 敵をひとつづつチェックする
                ...
                // if (～～～～～～～～～) {　　～～～～　　}
				if (jikiX <= tekiX[i] && tekiX[i] <= (jikiX + jikiW) 
						&& jikiY <= tekiW[i] && tekiW[i] <= (jikiY + jikiH))
                {
                    atariFlag = true;
                }
				
				
				if (jikiX <= tekiY[i] && tekiY[i] <= (jikiX + jikiW) 
						&& jikiY <= tekiH[i] && tekiH[i] <= (jikiY + jikiH))
                {
                    atariFlag = true;
                }
				
				
				if (jikiX <= tekiW[i] && tekiW[i] <= (jikiX + jikiW) 
						&& jikiY <= tekiH[i] && tekiH[i] <= (jikiY + jikiH))
                {
                    atariFlag = true;
                }
				...
				if (jikiX <= (tekiX[i]+tekiW[i]) && (tekiX[i] + tekiW[i]) <= (jikiX + jikiW) 
						&& jikiY <= (tekiX[i] + tekiW[i]) && (tekiX[i] + tekiW[i]) <= (jikiY + jikiH))
                {
                    atariFlag = true;
                }
				
				
				if (jikiX <= (tekiY[i] + tekiW[i]) && (tekiY[i] + tekiW[i]) <= (jikiX + jikiW) 
						&& jikiY <= (tekiY[i] + tekiW[i]) && (tekiY[i] + tekiW[i]) <= (jikiY + jikiH))
                {
                    atariFlag = true;
                }
				
				
				if (jikiX <= (tekiX[i] + tekiH[i]) && (tekiX[i] + tekiH[i]) <= (jikiX + jikiW) 
						&& jikiY <= (tekiX[i] + tekiH[i]) && (tekiX[i] + tekiH[i]) <= (jikiY + jikiH))
                {
                    atariFlag = true;
                }
				
				
				if (jikiX <= (tekiW[i] + tekiH[i]) && (tekiW[i] + tekiH[i]) <= (jikiX + jikiW) 
						&& jikiY <= (tekiW[i] + tekiH[i]) && (tekiW[i] + tekiH[i]) <= (jikiY + jikiH))
                {
                    atariFlag = true;
                }
